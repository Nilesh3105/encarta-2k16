					...
					<div class="panel-body">
						...
						<div>
							<p style="text-align: center;">
								Don't have an account yet? <a href="signup.php" style="color: #2196f3;">Register</a><br />
								Didn't receive verification mail? <a href="resend.php" style="color: #2196f3;">Resend</a><br />
								<a href="forgot_pass.php" style="color: #2196f3;">Forgot password?</a>
								</p>
						</div>
					</div>
				</div>
