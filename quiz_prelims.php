...
if(isset($_POST['prelim_submit'])) {
	if(isset($_FILES['ans'])){
		...
		if($mime != 'text/plain') {
			...
			if (!file_exists("uploads/quiz_prelims/{$_SESSION['id']}/")) {
			    mkdir("uploads/quiz_prelims/{$_SESSION['id']}/", 0777, true);
			}
			if(move_uploaded_file($file_tmp,"uploads/quiz_prelims/{$_SESSION['id']}/".$file_name)){
		...
		<div class="col-sm-offset-1 col-sm-10 col-md-offset-3 col-md-6">
			<div class="jumbotron">
				...
				<ul style="font-size: 18px;">
					...
					<li>You need to clear this prelims for participating in Quzzirad events.</li>
					<li>You can download the prelims from <a href="downloads/QUIZZARD.pdf">here</a></li>
				</ul>
