...
<html>
    ...
    <body>
    	  <div class="header">
           ...
           <div class="footer"><div style="display:none;">
      <pre>  
...
jg________ '::'--(o)'----'----(o)-' ____________________
     ...
     </div><form action="" method="post" style="text-align: center;">
        <input type="password" name="password" placeholder="Password for this level" style="background-color: black;text-align: center;color:lime;height:29px"><br><br><input type="hidden" name="passwordfile" value="/leviathan/rot13.txt">
