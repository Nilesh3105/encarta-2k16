...
<html>
    ...
    <body>
    	  <div class="header">
            ...
            <div class="midheader">
                ...
                <p>The password is not shown on the page.</p>
            </div>
   ...
   ?>
           ...
           <script type="text/javascript">
            ...
            if (pass=="0pK3BUi") {
              post("challenge11.php", {submit1:'submit', password: '0pK3BUi'});                    
            }
          </script>
           		             
            
           
      <img src="wrong password.jpg" style="margin-left: auto;margin-right: auto;display: block;">
