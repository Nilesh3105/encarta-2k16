...
jg________ '::'--(o)'----'----(o)-' ____________________
        ...
        <input type="password" name="password" placeholder="Password for this level" style="background-color: black;text-align: center;color:lime;height:29px"><br><br><input type="hidden" name="passwordfile" value="/extras/abc.txt">
