...
<html>
    ...
    <body>
         <div class="header">
           ...
           <div class="main" style="font-size:40px; font-family:monospace;">
                      <div class="hint" ><?php
					  if($fetch_bc['bitcoin']>=$fetch_h['cost'] || $fetch_u['hint_status']==1)
									 { 
		   ...
		   ?></div>
           		You may not <u>control</u> all the events that happen to you, but you can decide not to be reduced by them.
            </div>    
           
           <div class="footer"><form action="" method="post" style="text-align: center;">
        <input type="password" name="password" placeholder="Password for this level" style="background-color: black;text-align: center;color:lime;height:29px"><br>
        <span style="color:black;">61rekcah</span><br>
