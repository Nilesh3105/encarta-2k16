				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-6" >
							...
							<li>Download Prelims to participate in various events <a href="profile.php">here</a></li>
						</ul>
						</div>
														...
														<ul id="thumbs">
															...
															<li class="item-thumbs span3 codefiesta">
																...
																<p style="display:none" id="paracodemarathon" >Get ready for some food of thought and a test for your dexterity!!!
																	This 3 day long contest to test your coding expertise with a plethora of questions and to unravel the coding marvel within you, is scheduled to be held on CODE CHEF from 25th of November 2016 to 27th of November 2016.
																	Will you survive or fall in this abyss of marathon of code.
																	To paticipate in this event you need to register on codechef. This is an individual event, please visit http://codechef.com/ </p>
																...
																<li class="item-thumbs span3 codefiesta">
																	...
																	<li class="item-thumbs span3 quizzard">
																		...
																		<li class="item-thumbs span3 codefiesta">
																			...
																			<p style="display:none" id="parabandit" >The hacker explores the intersection of art and science in an insatiable quest to understand and shape the world around him. Bandit is a system of challenges, where everything challenges the user in different ways, which focus on quality, difficulty and originality of the tasks. The events are 0%simulation & guessing, Hacking challenges only!
																			Wargames, Reversing, Web-Hacking (no, not only PHP/MySQL), Cryptography(more about AES & RSA than old school algorithms), and Forensics, etc.
																			W3LC0M3 T0 T#3 R34L W0RLD, C0M3 9L4Y W1T# U$ 4ND 5P4WN 50M3 5#3LLZ! Key to next level lies within the current level.
																			There are two rounds- first one will be of duration 1 hr and selected teams will compete for second round which is online.
																			No. of participants per team:2</p>
